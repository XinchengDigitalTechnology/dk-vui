<template>
  ...
  <el-dialog v-if="load" :close-on-click-modal="false" title="高级查询" v-model="visible" append-to-body width="1000px" class="v-highform"
    @close="handleClose">
    <slot></slot>
    <template #footer>
      <SaveForm v-if="table.formConfig.save" placement="top" class="v-highform-save" />
